...
int main() {
    ...
    printf("Nombre entier aléatoire maximal: %d\n", randMax());

    // Générer et afficher un nombre entier aléatoire entre 0 et 100
    printf("Nombre entier aléatoire entre 0 et 100: %d\n", randUpTo(100));

    // Générer et afficher un nombre entier aléatoire entre 50 et 150
    printf("Nombre entier aléatoire entre 50 et 150: %d\n", randBetween(50, 150));
    ...
    printf("Nombre réel aléatoire à deux décimales entre 1.00 et 2.00: %.2f\n", randRealPrecise(1.00, 2.00));
